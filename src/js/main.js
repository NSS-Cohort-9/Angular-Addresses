angular
  ...
  .controller('PersonController', function ($http, $routeParams) {
    ...
    $http
      .get(`https://dontbreakthistime.firebaseio.com/people/${id}.json`)
  ...
  .controller('Main', function ($http) {
    ...
    $http
      .get('https://dontbreakthistime.firebaseio.com/people.json')
      .success(function (data) {
        vm.people = data;
      });
    ...
    vm.addNewAddress = function () {
      $http
        .post('https://dontbreakthistime.firebaseio.com/people.json', vm.newPerson)
    ...
    vm.removeAddress = function (id) {
      $http
        .delete(`https://dontbreakthistime.firebaseio.com/people/${id}.json`)
        .success(function () {
          delete vm.people[id]
        });
    };
